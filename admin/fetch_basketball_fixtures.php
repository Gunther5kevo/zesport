...
$sql_competition = "SELECT competition_name FROM basketballcompetitions WHERE id = :competition_id";
...
if (isset($_POST['competition_id'])) {
    ...
    $sql = "SELECT id, match_date, home_team_id, away_team_id FROM basketball_matches WHERE competition_id = :competition_id";
    ...
    foreach ($fixtures as $fixture) {
        $stmt = $pdo->prepare("SELECT team_name FROM basketball_teams WHERE id = :team_id");
