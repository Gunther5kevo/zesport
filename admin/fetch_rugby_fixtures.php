...
$sql_competition = "SELECT competition_name FROM rugby_competitions WHERE id = :competition_id";
...
if (isset($_POST['competition_id'])) {
    ...
    foreach ($fixtures as $fixture) {
        $stmt = $pdo->prepare("SELECT team_name FROM rugby_teams WHERE id = :team_id");
