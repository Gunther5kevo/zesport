...
try {
    ...
    // Fetch rugby teams
    $sqlTeams = "SELECT id, team_name FROM rugby_teams ORDER BY team_name";
        ...
        <div class="col-md-12">
            <div class="card">
                ...
                <form method="post" action="admin_functions.php">
                    ...
                    <button type="submit" name="create_rugby_fixture" class="btn btn-primary">Create Fixture</button>
                </form>
            </div>
        </div>
    </div>
