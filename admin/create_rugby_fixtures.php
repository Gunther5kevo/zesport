...
try {
    ...
    $sql_teams = "SELECT id, team_name FROM rugby_teams WHERE gender = :gender ORDER BY team_name";
...
<div class="row">
    <div class="col-md-12">
        <div class="card">
            <?= alertMessage(); ?>
            <h4>Create New Rugby Fixture</h4>
...
$(document).ready(function() {
    function getCompetitions() {
        ...
        $.ajax({
            url: '../datalayer/fetch_rugby_competitions.php', // Ensure this path is correct
            method: 'GET',
    ...
    function getTeams() {
        var gender = $('#gender').val();
        $.ajax({
            url: '../datalayer/fetch_rugby_teams.php', // Ensure this path is correct
            method: 'GET',
            data: { gender: gender },
            dataType: 'json',
            success: function(response) {
