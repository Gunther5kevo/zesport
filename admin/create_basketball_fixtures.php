...
<div class="row">
    <div class="col-md-12">
        <div class="card">
            <?= alertMessage(); ?>
            <h4>Create New Basketball Fixture</h4>
...
$(document).ready(function() {
    function getCompetitions() {
        ...
        $.ajax({
            url: '../datalayer/fetch_basketball_competitions.php', // Ensure this path is correct
            method: 'GET',
    ...
    function getTeams() {
        var gender = $('#gender').val();
        $.ajax({
            url: '../datalayer/fetch_basketball_teams.php', // Ensure this path is correct
            method: 'GET',
            data: { gender: gender },
            dataType: 'json',
            success: function(response) {
