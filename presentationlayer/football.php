            ...
            <div id="tabs">
                <ul class="nav nav-tabs" id="myTab" role="tablist">
                    <li class="nav-item" role="presentation">
                        <a class="nav-link active" id="fixtures-tab" data-bs-toggle="tab" href="#fixtures" role="tab" aria-controls="fixtures" aria-selected="true">Fixtures</a>
                    </li>
                    <li class="nav-item" role="presentation">
                    ...
                    <li class="nav-item" role="presentation">
                        <a class="nav-link" id="standings-tab" data-bs-toggle="tab" href="#standings" role="tab" aria-controls="standings" aria-selected="false">Standings</a>
                    </li>
                </ul>
        ...
        $.ajax({
            ...
            success: function(response) {
                ...
                competitions.forEach(function(competition) {
                    ...
                    sidebarHtml += '<a class="nav-link competition-link" data-competition-id="' + competition.id + '" href="#">' + competition.competition_name + '</a>';
                    sidebarHtml += '</li>';
                });
        ...
        $.ajax({
            ...
            success: function(response) {
                ...
                if (fixtures.message) {
                    ...
                    fixturesHtml += '<thead><tr><th>Date</th><th>Time</th><th>Home Team</th><th>Away Team</th><th>Venue</th><th>Referee</th></tr></thead>';
                    fixturesHtml += '<tbody>';
            ...
            success: function(response) {
                ...
                if (results.length === 0) {
                    ...
                    results.forEach(function(result) {
                        ...
                        var score = (homeScore !== '-' && awayScore !== '-') ? homeScore + ' - ' + awayScore : '-';
