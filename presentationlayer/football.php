        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="football.php?action=fixtures">Fixtures</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="football.php?action=results">Results</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="football.php?action=news">News</a>
                    </li>
                </ul>
            </div>
        </div>
