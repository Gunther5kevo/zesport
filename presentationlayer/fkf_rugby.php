...
$url = "https://www.kru.co.ke/kenya-cup/national-sevens-circuit/standings/";
...
try {
    ...
    $table = $html->find('table', 0); // Assuming the table is the second table in the page

    if ($table) {
        echo "<h1>SportPesa National 7s Circuit</h1>";
        echo "<table>";
        ...
        foreach ($table->find('tr') as $index => $row) {
            ...
            $highlight_class = ($team_name === 'Zetech') ? 'highlight-row' : '';
